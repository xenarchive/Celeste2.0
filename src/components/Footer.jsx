      ...
      <div className="mx-auto max-w-7xl px-6 py-12 md:py-16">
        <div className="grid grid-cols-1 items-start gap-8 md:grid-cols-12">
          ...
          <div className="md:col-span-4">
            <a href="#" className="mb-4 inline-block">
              <h3 className="font-robert-medium text-2xl tracking-tight">
                Celesté 2.0
              </h3>
            </a>
            <p className="max-w-md text-sm text-white/70">
              A celebration of sound, vision and craft. Join our community for
              events, exhibitions and limited releases. Built with love and a
              touch of starlight.
            </p>
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-6">
              {/* Insta handle 1 */}
              <a
                href="https://www.instagram.com/pravasana_heritage?igsh=MWJtZ3k2MTV5a3RycQ%3D%3D"
                aria-label="Instagram handle 1"
              ...
              {/* Insta handle 2 */}
              <a
                href="https://www.instagram.com/celeste_pravasana?igsh=bXVtZnQxY24yd2Jp"
                aria-label="Instagram handle 2"
                className="flex items-center gap-2 text-sm text-white/70 hover:text-white"
              >
                <span className="inline-flex size-6 items-center justify-center rounded-md bg-white/5">
                  <svg
          ...
          <div className="grid grid-cols-2 items-center gap-6 md:col-span-5">
            <div>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                ...
                <li>
                  <a href="#events" className="hover:text-white"></a>
                </li>
                <li>
                  <a href="#gallery" className="hover:text-white"></a>
                </li>
                <li>
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-6 sm:flex-row">
          <p className="text-sm text-white/60">
            © {new Date().getFullYear()} Celesté 2.0. All rights reserved.
          </p>
